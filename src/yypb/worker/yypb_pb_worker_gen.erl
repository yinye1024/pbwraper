...
%% ===================================================================================
do_handle_call(Msg,State)->
  Reply = bs_yypb_pb_worker_mgr:call_do_fun(Msg),
  {?REPLY,Reply,State}.


do_handle_cast(Msg,State)->
  bs_yypb_pb_worker_mgr:cast_do_fun(Msg),
  {?NO_REPLY,State}.

do_handle_info({loop_tick},State)->
  ?TRY_CATCH(bs_yypb_pb_worker_mgr:loop_tick()),
  erlang:send_after(?GEN_TICK_SPAN,self(),{loop_tick}),
  {?NO_REPLY,State};
do_handle_info(Msg,State)->
