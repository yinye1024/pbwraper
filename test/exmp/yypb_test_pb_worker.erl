...
%% return NewWorkData
loop_tick(WorkData)->
  Tick = yypb_test_pb_worker_data:get_tick(WorkData),
  NewWorkData = yypb_test_pb_worker_data:set_tick(Tick,WorkData),
...
add_count(Param,WorkData)->
  Count = yypb_test_pb_worker_data:get_tick(WorkData),
  Count+Param.
